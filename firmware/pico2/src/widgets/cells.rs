...
//! - **Low (oil only)**: "LOW" badge in top-left with blinking colors (red/white ↔ white/black) when < 75°C. Label
//!   shifts right to avoid overlap.
...
/// Check if oil temperature is below the low threshold (75°C).
///
