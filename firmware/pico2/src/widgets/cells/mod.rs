...
pub use temp::{
    draw_temp_cell, is_critical_egt, is_critical_iat, is_critical_oil_dsg, is_critical_water,
    is_low_temp_oil, temp_color_egt, temp_color_iat, temp_color_oil_dsg, temp_color_water,
};
...
#[inline]
pub(crate) fn peak_highlight_for_text(base_text: Rgb565) -> Rgb565 {
