...
use dashboard_common::colors::{RED, WHITE};
use dashboard_common::config::{CENTER_X, CENTER_Y, SCREEN_HEIGHT, SCREEN_WIDTH};
use dashboard_common::styles::{CENTERED, TITLE_STYLE_WHITE};
